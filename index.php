...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_FILES['uploaded_file'])) {
    ...
    if (move_uploaded_file($_FILES['uploaded_file']['tmp_name'], $target_file)) {
        ...
        echo "Wystąpił problem z przesyłwwwwwwwaaaaaaaaaaaaaaaaaawwwwwwwwwwwwwwwwwwwwwwwaniem plikU.";
    }
}
?>
...
<head>
    ...
    <title>awhhhhhhhhhhhwwhhhhhaaaaaaaaaawehhhhhhweeuwaaaaaaaaaaaaaaaaaaaaawwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwweew</title>
     <style>
        body {
