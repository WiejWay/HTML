...
while True:
    ...
    screenshot_filename = os.path.join(screens_folder, f"screenseeeeewwwwwwwwwwwwwwwwwweeeehot_{pyautogui.time.time()}.png")
    ...
    try:
        ...
        if previous_read is not None and current_read/total <= 0.5:
            ...
            print(f"UWAGA! Obecny odczwwwwyt spadł WWWWWWWWAAAAAAAAAEEEEEEEEAAAAAAAWWWWWWWWWWWWEEWWWWW 50%: {filtered_text}")
