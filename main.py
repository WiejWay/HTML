...
while True:
    ...
    try:
        ...
        if previous_read is not None and current_read/total <= 0.5:
            ...
            print(f"UWAGA! Obecny odczwwwwyt spaaaaaaaaaaaaaaeeeeeeeeeeeeeeeeeeeeeaadł eeeewwwwweeeeeeeeeeeeeeeeeeeeeafraaaaaaaaaaaaaaaaaaaaawwwwwwaaw 50%: {filtered_text}")
w
